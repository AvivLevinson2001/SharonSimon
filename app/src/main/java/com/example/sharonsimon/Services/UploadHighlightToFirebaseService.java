...
public class UploadHighlightToFirebaseService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, final int startId) {
        ...
        Intent deleteIntent = new Intent(this, UploadHighlightToFirebaseService.class);
        deleteIntent.putExtra("startIdToCancel", startId);
        PendingIntent deletePendingIntent = PendingIntent.getService(this,
                0,
                deleteIntent,
                PendingIntent.FLAG_CANCEL_CURRENT);

        builder.addAction(R.drawable.ic_cancel_black_24dp, "Stop", deletePendingIntent);
